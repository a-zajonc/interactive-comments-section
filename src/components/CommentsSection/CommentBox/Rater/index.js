...
function Rater({ score }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_1.Box, Object.assign({ bgColor: "#EAECF1", rounded: "10px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-evenly", h: "130px", w: "40px", marginRight: "20px" }, { children: [(0, jsx_runtime_1.jsx)(react_1.IconButton, { bgColor: "#EAECF1", _hover: { bgColor: "#EAECF1", color: "#5457B6" }, _focus: { bgColor: "#EAECF1" }, padding: "10px", "aria-label": "Rate with plus", color: "#C5C6EF", icon: (0, jsx_runtime_1.jsx)(icons_1.AddIcon, {}), onClick: () => {
