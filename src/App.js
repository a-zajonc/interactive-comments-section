    ...
    Object.assign(
      { display: "flex", justifyContent: "center", marginBlock: "80px" },
      {
        children: (0, jsx_runtime_1.jsx)(
          context_1.CommentsContext.Provider,
          Object.assign(
            { value: { comments, setComments } },
            {
              children: (0, jsx_runtime_1.jsx)(
                context_1.EditContext.Provider,
                Object.assign(
                  { value: { editID, setEditID } },
                  {
                    children: (0, jsx_runtime_1.jsx)(
                      context_1.ReplyContext.Provider,
                      Object.assign(
                        { value: { replyID, setReplyID } },
                        {
                          children: (0, jsx_runtime_1.jsx)(
                            context_1.DeleteContext.Provider,
                            Object.assign(
                              { value: { deleteID, setDeleteID } },
                              {
                                children: (0, jsx_runtime_1.jsx)(
                                  context_1.ReplyToUsernameContext.Provider,
                                  Object.assign(
                                    {
                                      value: {
                                        replyToUsername,
